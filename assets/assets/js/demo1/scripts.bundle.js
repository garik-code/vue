...
var KTApp = function() {
    ...
    $('.nav__dropdown-toggler').on('click', function (e) {
        e.preventDefault();
        var menu = $(this).siblings('.nav__dropdown-menu');
        if (!$(this).parent().hasClass('active')) {
            $('.nav__dropdown').removeClass('active');
            $(this).parent().addClass('active');
            $('.nav__dropdown-menu').slideUp('slow');
            menu.slideDown('slow');
        }
        else {
    ...
    $('.nav__dropdown-item > a.dropdown-link').on('click', function () {
        $('.nav__dropdown-item > a.dropdown-link').removeClass('active');
    })
